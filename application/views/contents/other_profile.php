			...
			<div class="col-lg-8 col-lg-offset-2">
				<div class="box box-default">
					<div class="box-body box-profile">
						<img class="profile-user-img img-responsive img-circle" alt="User profile picture" id="other-profile-pic" src="<?php echo base_url()."assets/uploads/".$query->image?>">
						<h4 name="other-profile-name" class="profile-username text-center"><?php echo $query->firstname ." ".$query->lastname?></h4>
